...
void BCMenu::MeasureItem( LPMEASUREITEMSTRUCT lpMIS )
{
	...
	if(state & MF_SEPARATOR){
		...
		////////////////////////////////////////////////////
		// Bug fix: abin 2011-10-10
		////////////////////////////////////////////////////
		if (lpMIS->CtlID == 0 || wcsrchr(lpstrText, '\t'))
			t.cx += 16;
...
////////////////////////////////////////////////////////
// Helper class greatly reduces codes in your CMainFrame
// class if derived from CBCFrameWnd
//
// Added by Abin 2011-10-10
////////////////////////////////////////////////////////

IMPLEMENT_DYNAMIC(CBCFrameWnd, CFrameWnd)

BEGIN_MESSAGE_MAP(CBCFrameWnd, CFrameWnd)
	ON_WM_CREATE()
	ON_WM_MEASUREITEM()
	ON_WM_MENUCHAR()
	ON_WM_INITMENUPOPUP()
...
int CBCFrameWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	if (CFrameWnd::OnCreate(lpCreateStruct) == -1)
		return -1;

	// Destroy the original menu
	CMenu* pMenu = GetMenu();
	if (pMenu)
		pMenu->DestroyMenu();	
	...
	// Replace the default menu	with our BCMenu object
	SetMenu(&m_menu);
	m_hMenuDefault = (HMENU)m_menu;
	return 0;
}

void CBCFrameWnd::OnMeasureItem(int nIDCtl, LPMEASUREITEMSTRUCT lpMeasureItemStruct) 
{
...
LRESULT CBCFrameWnd::OnMenuChar(UINT nChar, UINT nFlags, CMenu* pMenu) 
{
...
void CBCFrameWnd::OnInitMenuPopup(CMenu* pPopupMenu, UINT nIndex, BOOL bSysMenu) 
{
	CFrameWnd::OnInitMenuPopup(pPopupMenu, nIndex, bSysMenu);
	if (!bSysMenu && m_menu.IsMenu(pPopupMenu))
